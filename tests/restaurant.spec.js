...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(typeof obj.fetchMenu).toEqual('function');
    ...
    expect(Object.keys(obj.fetchMenu())).toEqual(['food', 'drink']);
    ...
    obj.order('coxinha');
    expect(obj.consumption.find((string) => string === 'coxinha')).toEqual('coxinha');
    ...
    obj.order('coxinha');
    expect(obj.consumption).toEqual(['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha']);
    ...
    expect(obj.pay()).toBeCloseTo(12.87);
